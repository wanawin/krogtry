# BUILD: core025_all3_member_straight_rank_streamlit_SINGLEFILE__2026-05-11_v5_TXT_CSV_IO
...
BUILD_MARKER='BUILD: core025_all3_member_straight_rank_streamlit_SINGLEFILE__2026-05-11_v5_TXT_CSV_IO'
...
st.info('Single-file v5. Accepts TXT/CSV/TSV inputs and produces both CSV + TXT downloads.')
with st.sidebar:
    st.header('Inputs')
